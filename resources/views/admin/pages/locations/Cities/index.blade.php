...
@section('content')
    ...
    <header class="page-header page-header-left-inline-breadcrumb">
        <h2 class="font-weight-bold text-6">Cities</h2>
                        ...
                        <div class="datatable-header">
                            <div class="row align-items-center mb-3">
                                <div class="col-12 col-lg-auto mb-3 mb-lg-0">
                                    <a href="{{ route('city-management.create') }}" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Add City</a>
                                </div>
                                ...
                                @foreach ($city as $key => $row)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a class="btn btn-warning" href="{{ route('city-management.edit',$row->id) }}" style="padding: 4px 6px;font-size: 12px;"><i class="fas fa-pen"></i></a>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="verticalCenterTitle">Delete City</h5>
