...
{{--                                        </td>--}}
                                        <td style="text-align: center">
                                            <form action="{{ route('delete.offer',$row->id) }}" id="delete-offer-{{ $row->id }}" method="GET">
                                            </form>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 1000px">
                                                    <div class="modal-content">
                                                                                    ...
                                                                                    <div class="profile-img text-center rounded-circle">
                                                                                        <div class="pt-5">
                                                                                            ...
                                                                                            <div class="profile pt-4">
                                                                                                ...
                                                                                                <p>by {{ $row->shop->seller->user->name }}</p>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="py-3 profile-counter">
                                                                                        <ul class="nav justify-content-center text-center">
                                                                                            ...
                                                                                            <li class="nav-item  px-3">
                                                                                                <div>
                                                                                                    <h4 class="mb-0">@if($row->insights != null)
                                                                                ...
                                                                                <div class="page-account-form">
                                                                                    ...
                                                                                    <div class="p-4">
                                                                                        <div class="form-row border-bottom mb-4" >
                                                                                            ...
                                                                                            <div class="col-md-4 mb-3">
                                                                                                <label for="name1">Title: {{ $row->title }}</label>
                                                                                            </div>
                                                                                            <div class="col-md-12 mb-3">
                                                                                                <label for="title1">Category: {{ $row->category->name }}, {{ $row->subcategory->name }}</label>
                                                                                            </div>
                                                                                            <div class="col-md-12 mb-3">
                                                                                                <label for="phone1">Targeted Area: {{ $row->getarea->name }}, {{ $row->getarea->city->name }}, {{ $row->getarea->city->province->name }}</label>
                                                                                            </div>

                                                                                            <div class="col-md-12 mb-3">
                                                                                                <label for="phone1">Decription: {{ $row->description }}</label>
                                                                                            </div>
                                                                                        </div>
                                                                                        <h5 class="">Uploaded Details</h5>
                                                                                        <div class="form-row">
                                                                                            <div class="col-md-6 mb-3">
                                                                                                <label for="name1">Created At: {{ $row->created_at->diffForHumans() }}</label>
                                                                                            </div>
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-primary" onclick="closeViewModal({{ $row->id }})">Close</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <button class="btn btn-danger" onclick="openDeleteModal({{$row->id}})" style="padding: 6px 8px;font-size: 14px;"><i class="fas fa-times"></i></button>
                                            <button class="btn btn-primary" onclick="openViewModal({{ $row->id }})" style="padding: 6px 8px;font-size: 14px;"><i class="fas fa-eye"></i></button>
                                        </td>
                                    </tr>
                                @endforeach
