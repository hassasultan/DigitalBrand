...
@section('content')
    ...
    <header class="page-header page-header-left-inline-breadcrumb">
        <h2 class="font-weight-bold text-6">Sub-Categories</h2>
                        ...
                        <div class="datatable-header">
                            <div class="row align-items-center mb-3">
                                <div class="col-12 col-lg-auto mb-3 mb-lg-0">
                                    <a href="{{ route('offer-sub-categories.create') }}" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Add Sub Category</a>
                                </div>
                                ...
                                <div class="col-12 col-lg-auto ps-lg-1">
                                    <div class="search search-style-1 search-style-1-lg mx-lg-auto">
                                        <div class="input-group">
                                            <input type="text" class="search-term form-control" name="search-term" id="search-term" placeholder="Search Sub Category">
                                ...
                                @foreach ($subcat as $key => $row)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="{{ route('offer-sub-categories.edit',$row->id) }}" class="btn btn-warning" style="padding: 4px 6px;font-size: 12px;"><i class="fas fa-pen"></i></a>
{{--                                            <button class="btn btn-primary"  style="padding: 4px 6px;font-size: 12px;"><i class="fas fa-eye"></i></button>--}}
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="verticalCenterTitle">Delete Sub-Category</h5>
    ...
    <script>
        ...
        {
            console.log(frmid);
            $("#delete-subcategory-"+frmid).submit();
        }
