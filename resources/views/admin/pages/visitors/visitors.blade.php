...
@section('content')
    ...
    <header class="page-header page-header-left-inline-breadcrumb">
        <h2 class="font-weight-bold text-6">Visitors</h2>
        <div class="right-wrapper">
            <ol class="breadcrumbs">
                <li><span>Dashboard</span></li>
                <li><span>Visitors</span></li>
                <li><span>Visitor List</span></li>
            </ol>
        </div>
    </header>
...
{{--                                        <td>{{ ++$key }}</td>--}}
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-warning" style="padding: 4px 6px;font-size: 12px;" href="{{ route('visitor-management.edit',$row->id) }}"><i class="fas fa-pen"></i></a>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="verticalCenterTitle">Delete Visitor</h5>
